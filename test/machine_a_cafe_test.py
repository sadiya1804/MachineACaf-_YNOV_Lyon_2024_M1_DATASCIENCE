...
class MyTestCase(unittest.TestCase):
    ...
    def test_add_latte(self):
        ...
        matcher.assertLatteOrdered(brewer)
        # Et le montant total est 50 + 70 = 120
        matcher.assertAmountCharged(carte, -120)
    ...
    def test_add_capuccino(self):
        ...
        matcher.assertCappuccinoOrdered(brewer)
        # Et le montant total est 50 + 80 = 130
        matcher.assertAmountCharged(carte, -130)
    ...
    def test_no_chocolate(self):
        ...
        matcher.assertNoChocolateOrdered(brewer)
    ...
    def test_no_latte(self):
        ...
        matcher.assertNoLatteOrdered(brewer)
